...
func _layout() -> void:
    ...
    build_panel.position = Vector2((width - 214.0) * 0.5, 87)
    build_panel.size = Vector2(214, 57)
    build_title.position = Vector2(9, 4)
    build_title.size = Vector2(196, 13)
    build_effect.position = Vector2(9, 19)
    build_effect.size = Vector2(196, 23)
    build_cost.position = Vector2(9, 42)
    build_cost.size = Vector2(196, 11)
