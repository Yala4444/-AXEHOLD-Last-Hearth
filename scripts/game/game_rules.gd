...
const BIOMES := [
    ...
    },
    {
        ...
        "rule":"Больше камня. Морозные удары замедляют героя, а белые бури меняют безопасный маршрут.",
        "night_speed":0.90,
    ...
    },
    {
        ...
        "rule":"Больше руды. Тяжёлые враги оставляют жар после смерти, а разломы земли давят на позиционирование.",
        "night_speed":1.0,
